...
describe("optional research configuration", () => {
	it("lets an onboarded rep enter the CRM without a key", async () => {
	...
	it("redirects the old research URL into the CRM", async () => {
		setup({ configured: false });
	...
	it("requires workspace onboarding without a research key", async () => {
		setup({ onboarded: false, configured: false });
	...
	it("enters the CRM after workspace onboarding without a key", async () => {
